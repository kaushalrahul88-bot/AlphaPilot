...
settings = Settings()
app = FastAPI(title="AlphaPilot API", version="0.13.1")
...
@app.get("/health")
async def health(): return {"ok":True,"service":"alphapilot-api","version":"0.13.1","provider":settings.market_data_provider.upper()}
