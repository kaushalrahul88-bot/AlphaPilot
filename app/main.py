...
@app.get("/health")
async def health(): return {"ok":True,"service":"alphapilot-api","version":"0.38.3","provider":settings.market_data_provider.upper()}
