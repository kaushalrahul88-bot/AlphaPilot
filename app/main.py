...
@app.get("/health")
async def health(): return {"ok":True,"service":"alphapilot-api","version":"0.32.1","provider":settings.market_data_provider.upper()}
