...
def architecture_contract() -> dict:
    return {
        ...
        "futures_data_may_generate_options_trade": False,
        "options_data_may_inform_underlying_market_state_as_context_only": True,
        "options_data_may_create_underlying_direction": False,
