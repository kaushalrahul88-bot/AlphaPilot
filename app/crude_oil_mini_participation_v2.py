...
def build_participation_observation(
    ...
    *,
    ...
    The family is allowed to vote direction only when fresh positioning evidence (OI)
    and auction acceptance agree. Price plus volume alone is explicitly marked as
    dependent on local price and cannot masquerade as a second independent vote.

    No Current Mind rule consumes this object.
    """
