...
if os.getenv("RENDER_GIT_COMMIT"):
    ...
    from .fno_v7_holdout_c_admission_pause import register_fno_v7_holdout_c_admission_pause  # noqa: E402
    ...
    from .fno_v1_current_expiry_comparator_api import register_fno_v1_current_expiry_comparator_routes  # noqa: E402
    ...
    register_fno_v7_holdout_c_admission_pause(_app)
    ...
    register_crypto_btc_dashboard_action_routes(_app, _settings)
