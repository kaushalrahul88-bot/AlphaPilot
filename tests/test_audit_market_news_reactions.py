...
class MarketNewsReactionAuditTests(unittest.TestCase):
    ...
    def news(self,outcome=None):
        r={"available_at":"2026-08-07T10:00:00+05:30","source":"Reuters","value":{"headline":"Supply disruption"},
    ...
    def test_classifies_frozen_event(self):
        r=audit(self.news(),self.candles())
    ...
    def test_outcome_metadata_cannot_change_audit(self):
        a=audit(self.news("TARGET"),self.candles());b=audit(self.news("STOP"),self.candles())
