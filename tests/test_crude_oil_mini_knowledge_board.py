...
from app.crude_oil_mini_knowledge_board import knowledge_board
...
class CrudeOilMiniKnowledgeBoardTests(unittest.TestCase):
    ...
    def test_wti_requires_a_genuinely_visible_observation(self):
        ...
        board = knowledge_board([future_wti], CLICK)
        ...
        board = knowledge_board([visible_wti], CLICK)
    ...
    def test_fx_translation_requires_both_wti_and_usdinr(self):
        ...
        wti_only = knowledge_board([wti], CLICK)
        both = knowledge_board([wti, fx], CLICK)
